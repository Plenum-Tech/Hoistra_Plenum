    ...
    <>
      ...
      <div style={{ marginTop: "32px" }}>
        <div style={{ minWidth: "0" }}>
          ...
          <div style={{ display: vals.asWithheldShow, margin: "10px 0 0", padding: "11px 14px", borderRadius: "9px", background: "var(--color-bg)", border: "1px solid var(--color-divider)", fontSize: "11.5px", color: "var(--color-neutral-400)", lineHeight: "1.55" }}>
            {vals.asWithheldText}
          </div>
      ...
      <div style={{ padding: "16px", fontSize: "12px", color: "var(--color-neutral-500)", display: vals.iotEmpty, marginTop: "12px", borderRadius: "10px", background: "var(--color-surface)", lineHeight: "1.55" }}>
        {vals.iotEmptyText}
      </div>
